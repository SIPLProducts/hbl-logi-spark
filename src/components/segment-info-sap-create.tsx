...
const BASE_FIELDS: FieldSpec[] = [
  {
    ...
    value: "",
    type: "select",
    options: ["Ravi Kumar", "Suresh Reddy", "Anita Sharma"],
  },
  {
    label: "Segment",
    value: "",
    type: "select",
    options: ["Industrial", "Defence", "Telecom", "Retail"],
  },
  {
    label: "Application Type",
    value: "",
    type: "select",
    options: ["UPS", "Solar", "Telecom Tower", "Railway"],
  },
  ...
  return (
    <div>
      ...
      {type === "select" ? (
        ...
        <input type="number" defaultValue={value} className={GREEN_INPUT} />
      ) : (
