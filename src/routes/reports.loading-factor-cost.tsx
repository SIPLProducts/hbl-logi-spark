...
import { BarChart3, FileSpreadsheet, Calendar, RotateCcw } from "lucide-react";
...
function LoadingFactorCostReport() {
  const title = "Loading Factor & Cost";
  const description = "Vehicle loading factor and cost-per-ton trends.";
  return (
