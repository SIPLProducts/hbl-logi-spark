...
import { counts, sampleRows, type WorklistRow } from "@/lib/le-mock-data";
...
function ShipmentDetailsPage() {
  ...
  const rows: WorklistRow[] = sampleRows;
                  ...
                  <table className="w-full text-left border-collapse text-[12px]">
                    <thead>
                      <tr className="bg-gradient-primary text-[10px] font-bold uppercase tracking-[0.14em] text-primary-foreground">
                        ...
                        <th className="px-2 py-1.5 whitespace-nowrap">Sl.No</th>
                        <th className="px-2 py-1.5 whitespace-nowrap">Map ID</th>
                        <th className="px-2 py-1.5 whitespace-nowrap">Reference Number</th>
                        <th className="px-2 py-1.5 whitespace-nowrap">Work Order Number</th>
                        <th className="px-2 py-1.5 whitespace-nowrap">LR Number</th>
                        <th className="px-2 py-1.5 whitespace-nowrap">Transporter</th>
                    ...
                    <tbody className="divide-y divide-hairline/60">
                      {rows.map((r) => (
                        ...
                        >
                          ...
                          <td className="px-2 py-1 whitespace-nowrap">{r.slNo}</td>
                          <td className="px-2 py-1 whitespace-nowrap font-mono">{r.mapId}</td>
                          <td className="px-2 py-1 whitespace-nowrap font-mono">{r.reference}</td>
                          <td className="px-2 py-1 whitespace-nowrap font-mono">{r.workOrder}</td>
                          <td className="px-2 py-1 whitespace-nowrap font-mono">{r.lrNumber}</td>
                          <td className="px-2 py-1 whitespace-nowrap">{r.transporter}</td>
                      ...
                      {rows.length === 0 && (
                        <tr>
                          <td colSpan={8} className="px-3 py-10 text-center text-[12px] text-muted-foreground">
