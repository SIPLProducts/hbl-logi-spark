...
import { Settings, FileSpreadsheet, Calendar, RotateCcw } from "lucide-react";
...
function ServiceLevelReport() {
  const title = "Service Level";
  const description = "On-time delivery and service-level adherence by lane.";
  return (
