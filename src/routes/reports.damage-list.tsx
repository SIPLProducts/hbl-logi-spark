...
import { ListChecks, FileSpreadsheet, Calendar, RotateCcw } from "lucide-react";
...
function DamageListReport() {
  const title = "Damage List";
  const description = "Consolidated list of in-transit damages and resolutions.";
  return (
